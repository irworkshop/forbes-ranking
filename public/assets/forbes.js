...
window.JST['sidebar'] = template('<img src="<%= imageurl %>">\n<div class="forbes-info">\n    <h2><%= name %></h2>\n\n    <p>\n        <span class="forbes-net-worth">Net Worth: $<%= networth %></span> <br>\n        <%= title %>\n    </p>\n\n    <h3>Ranking</h3>\n    <ul class="forbes-ranking">\n        <li class="forbes-rank">Forbes:&nbsp;<%= forbesrank %></li>\n        <li class="forbes-donor-rank">Donor:&nbsp;<%= donorrank %></li>\n    </ul>\n\n</div>\n');
window.JST['table'] = template('<div class="forbes row-fluid">\n    <div class="forbes span8">\n        <table class="table table-hover forbes-ranking-table">\n            <thead>\n                <tr>\n                    <th>Forbes Rank</th>\n                    <th>Name</th>\n                    <th>Donor Rank</th>\n                </tr>\n            </thead>\n            <tbody></tbody>\n        </table>\n    </div>\n\n    <div class="forbes span4 forbes-people-sidebar">\n        <img src="http://placehold.it/145x191&text=placeholder">\n    </div>\n</div>\n');
})();